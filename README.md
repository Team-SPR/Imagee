...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imagee
```

A live public deployment of this template is available at [https://imagee.templates.workers.dev](https://imagee.templates.workers.dev)
